...
# subsequent word is uppercase. For instance, whereas a variable for a user’s name might be called name,
...
# with all letters in lowercase. For instance, those same variables would be called name, first_name, and preferred_first_name,
...
for c in camelCase:
    if c.isupper():
        print(snakeCase + "_" + c.lower(), end="")
    else:
        print(snakeCase + c, end="")
